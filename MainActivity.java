...
public class MainActivity extends Activity {  
    ...
    //包含所有按键，可隐藏
    private TableRow tab1,tab2,tab3,tab4,tab5,tab6,tab7,tab8,tab9,tab10,tab11; 
    private Button  
        div, mul, sub, add, equal,            // ÷ × - + =  
        sin, cos, tan, log, ln,               //函数  
        sqrt, square, factorial, bksp,        //根号  平方  阶乘   退格  
        left, right, dot,  drg,          //（     ）  .  退出     角度弧度控制键  
        mc, c,history,back,datadelete;                                // mem清屏键    input清屏键  
    ...
    {  
        ...
        tab1 = (TableRow)findViewById(R.id.tableRow1); 
        tab2 = (TableRow)findViewById(R.id.tableRow2); 
        tab3 = (TableRow)findViewById(R.id.tableRow3); 
        tab4 = (TableRow)findViewById(R.id.tableRow4); 
        tab5 = (TableRow)findViewById(R.id.tableRow5); 
        tab6 = (TableRow)findViewById(R.id.tableRow6); 
        tab7 = (TableRow)findViewById(R.id.tableRow7); 
        tab8 = (TableRow)findViewById(R.id.tableRow8); 
        tab9 = (TableRow)findViewById(R.id.tableRow9); 
        tab10 = (TableRow)findViewById(R.id.tableRow10); 
        tab11 = (TableRow)findViewById(R.id.tableRow11); 
    ...
    private OnClickListener actionPerformed = new OnClickListener() {  
        public void onClick(View v) {  
            ...
            //如果输入的是清除键  
                ...
                //hist调用历史记录
            ...
            else if(command.compareTo("hist") == 0) {  
                	...
                	tab10.setVisibility(View.VISIBLE);
                	...
                	tab8.setVisibility(View.VISIBLE);
                	tab9.setVisibility(View.VISIBLE);
                	tab10.setVisibility(View.GONE);
                	tab11.setVisibility(View.GONE);
    ...
    public class calc {  
         ...
         final int MAXLEN = 500;  
            ...
            public void process(String str) {  
                ...
                hist.append(str_old+"="+String.valueOf(FP(number[0]))+"\n"); 
            }  
